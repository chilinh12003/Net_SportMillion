...
var OxOe3dc=["ondblclick","navtd","shiftKey","style"];Window_GetElement(window,OxOe3dc[1],true)[OxOe3dc[0]]=function (){if(event[OxOe3dc[2]]){alert(element[OxOe3dc[3]].cssText);} ;} ;
</script>
