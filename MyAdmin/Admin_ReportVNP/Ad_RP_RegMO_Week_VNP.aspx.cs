...
{
    public partial class Ad_RP_RegMO_Week_VNP : System.Web.UI.Page
    {
        ...
        protected void Page_Init(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    mGetRole = new GetRole(MySetting.AdminSetting.ListPage.RP_WeekMOReg_VNP, Member.MemberGroupID());
                }
                else
                {
