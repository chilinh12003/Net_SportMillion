...
{
    public partial class Ad_RP_AnswerMO_Week_VNP : System.Web.UI.Page
    {
        ...
        public string LinkExportExcel()
        {
            try
            {
                ...
                ExportExcelObject mEPObject = new ExportExcelObject(ExportExcelObject.ExportType.MODuDoan_Tuan, BeginDate, EndDate, DateTime.Now,FileName);
        ...
        protected void Page_Init(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    mGetRole = new GetRole(MySetting.AdminSetting.ListPage.RP_WeekMOAnswer_VNP, Member.MemberGroupID());
                }
                else
                {
        ...
        private void BindChart()
        {
            try
            {
                ...
                for (int i = mTable.Rows.Count - 1; i >= 0; i--)
                {
                    ...
                    List_MOTotal.Add((double)mRow["MOAnswerTotal"]);
                    List_MOSuccess.Add((double)mRow["MOAnswerSuccess"]);
