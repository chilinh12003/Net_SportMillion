...
namespace MyAdmin.WS_SportMillion {
    ...
    public interface SportMillionSoap {
        ...
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        string Reg_VNP(string UserName, string IP, string Signature, MyAdmin.WS_SportMillion.ChannelType mChannel);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://hbcom.vn/DeReg_VNP", ReplyAction="*")]
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        string DeReg_VNP(string UserName, string IP, string Signature, MyAdmin.WS_SportMillion.ChannelType mChannel);
    }
    ...
    public partial class SportMillionSoapClient : System.ServiceModel.ClientBase<MyAdmin.WS_SportMillion.SportMillionSoap>, MyAdmin.WS_SportMillion.SportMillionSoap {
        ...
        public string Reg_VNP(string UserName, string IP, string Signature, MyAdmin.WS_SportMillion.ChannelType mChannel) {
            return base.Channel.Reg_VNP(UserName, IP, Signature, mChannel);
        }
        
        public string DeReg_VNP(string UserName, string IP, string Signature, MyAdmin.WS_SportMillion.ChannelType mChannel) {
